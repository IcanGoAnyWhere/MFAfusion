...
This repo is based on OpenPCDet for fusion lidar and camera.`OpenPCDet` is a clear, simple, self-contained open source project for LiDAR-based 3D object detection. 
