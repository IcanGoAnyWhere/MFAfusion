...
def img2avi():
    ...
    # 因为是文件夹，所以最后还要有一个“/”
    file_dir = '/home/xrd/PycharmProjects/VPFusion/OpenPCDet/data/kitti_track/capture/'
    list = []
    ...
    video = cv2.VideoWriter('/home/xrd/PycharmProjects/VPFusion/OpenPCDet/data/kitti_track/capture/test.avi',
                            cv2.VideoWriter_fourcc(*'MJPG'),20,(1280,720))
