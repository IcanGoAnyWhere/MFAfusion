...
class KittiDataset_demo(DatasetTemplate):
    ...
    def __getitem__(self, index):
        ...
        if "points" in get_item_list:
            ...
            # o3d.visualization.draw_geometries([pcd_point], window_name="origin",
        ...
        data_dict = self.prepare_data(data_dict=input_dict)  # filter  range of xyz
...
def create_kitti_infos(dataset_cfg, class_names, data_path, save_path, workers=4):
    dataset = KittiDataset_demo(dataset_cfg=dataset_cfg, class_names=class_names, root_path=data_path, training=False)
